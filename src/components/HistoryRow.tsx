...
const HistoryRow = ({saves,formula}: DataType) => {
  ...
  return (
    <div className="flex flex-row border-black border-t-2 w-full justify-end">
        ...
        <h1 className="font-normal text-2xl ml-4 pb-3">
         {saves}
        </h1>
      
    </div>
    <button onClick={copyToClipboard} className="bg-button_2 h-[50%] self-center text-center text-white px-3 py-2 rounded-xl mr-5">
